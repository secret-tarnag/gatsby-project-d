    ...
    <div className="joinus-container">
      <div className="joinus-form-container barlow" role="form">
        ...
        <form id="joinus-form" action="csatlakozz.html" method="post">
          ...
          <input id="w1" type="radio" name="worktype" value="webdeveloper" checked /><label for="w1">web development</label><br />
          <input id="w2" type="radio" name="worktype" value="creative" /><label for="w2">creative team</label><br />
          <input id="w3" type="radio" name="worktype" value="editor" /><label for="w3">content creation</label><br />
          ...
          <div className="joinus-register-link">
            ...
            <span><Link to="/en/regisztracio">Akkor ez az utad :)</Link></span>
          </div>
        </form>
      </div>
    </div>
