...
const varietyParagraphs = [
  '<span class="highlight">1.Distortion: </span>Thanks to the government, our economy has been constantly growing in ' +
  'the recent years (governmental media). Reality: The economy is actually growing, but so is our national debt and ' +
  'we are developing at a smaller rate than our neighbouring countries.',
  ...
  '<span class="highlight">2.Simple omission: </span> "&nbsp;&nbsp;" (party media). Reality: Two politicians, ' +
  ...
  '<span class="highlight">3. Discrimination: </span>Tipically cases, where the privileged  party member gets a page ' +
  'long illustrious  portrayals (e.g. before elections), while other politicans are not, or just barely mentioned. ' +
  'Take a look at the Febuary release of the ’Csepeli Hirmondó’ 2018 ' +
  '(<a href="https://444.hu/2018/02/23/10-foton-szerepel-es-19-alkalommal-van-leirva-nemeth-szilard-neve-a-csepeli' +
  '-ujsagban" target="_blank">article</a> | <a href="docs/CSH_163_.pdf" target="_blank">release</a>)<br>Józsefváros ' +
  'lapja (<a href="https://merce.hu/2018/07/06/jozsefvaros-lapja-nem-tud-a-keruleti-polgarmester-valasztasrol" ' +
  'target="_blank">article</a>| <a href="docs/jozsefvaros_ujsag_2018-23.pdf" target="_blank">release</a>)',
  '<span class="highlight">4.Positive dumping: </span>This is a wider phenomenon. It is based on the fact that ' +
  ...
  'E.g.:The analysis of the public service media broadcast ' +
  '(<a href="https://mertek.atlatszo.hu/a-szavak-ereje-manipulacios-eszkozok-a-hirszerkesztesben" target="_blank">' +
  'article</a> | <a href="docs/Szúrópróba-26.pdf" target="_blank">the study</a>).',
  '<span class="highlight">5.Simple lie: </span>As the title of this category suggests, we simply mean the ' +
  'intentional (or unintentional) spreading of false facts.',
  'For example, someone supposedly set money on fire in their backyard when they did not.',
  '<span class="highlight">6. A campaign for discrediting: </span>the targeted person (who is a threat to the party) ' +
  'is being tendentiously discredited in front of the public, based on personal faults or events that took place ' +
  ...
  '<span class="highlight">7.Incitement, hatred: </span> Intimidation/violence against people from different ethnic ' +
  ...
  'overlapping each other. In real life, they mostly appear as a combination of multiple types.',
];
