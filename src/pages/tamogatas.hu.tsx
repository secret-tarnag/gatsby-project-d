  ...
  <Layout>
    ...
    <div id="about" className="tabcontent">
      ...
      <p>Egy egyetemistákból álló csoport, és van egy nagy álmunk: azt kívánjuk, hogy a demokrácia
        Magyarországon újra igazán demokratikus legyen.</p><br /><br />
    </div>
    <div id="goals" className="tabcontent">
      ...
      <p>Valaki mondta, hogy a választás nem lehet szabad, ha az emberek nem dönthetnek szabadon. A szabad
        ...
        független és objektív újságírásnak lehet nevezni.</p>
      <p>Egy honlapot fejlesztünk, ahol az érdeklődők megtalálhatnak minden fontos információt az egyes
        médiumokról: tulajdonosok és politikai kötődéseik, szerkesztők, látogatottsági adatok, világnézet és
        ideológiai elköteleződés,
    ...
    <div id="contribute" className="tabcontent">
      ...
      <ul>
        <li>
          Ha tudsz programozni, és jártas vagy a webes technológiákban, akkor forkolj minket a
          <a href="https://github.com/daroczypal/project-d-." target="_blank">githubon</a>.
        </li>
